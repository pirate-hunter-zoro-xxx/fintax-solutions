      ...
      <div className="px-4 sm:px-10 lg:px-20 xl:px-40 flex justify-center py-8 lg:py-12">
        <div className="max-w-7xl w-full">
          <div className="container">
            <div className="p-4">
              <div
                className="flex min-h-[480px] lg:min-h-[600px] flex-col gap-6 bg-cover bg-center bg-no-repeat gap-8 rounded-xl lg:rounded-2xl items-start justify-end px-4 pb-10 px-10 lg:px-16 xl:px-20"
                style={{
                  backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.1) 0%, rgba(0, 0, 0, 0.4) 100%), url("https://images.unsplash.com/photo-1554224155-6726b3ff858f?ixlib=rb-4.0.3&auto=format&fit=crop&w=2226&q=80")`
                }}
              >
                <div className="flex flex-col gap-4 lg:gap-6 text-left max-w-4xl">
                  <h1 className="text-white text-4xl lg:text-6xl xl:text-7xl font-black leading-tight tracking-[-0.033em] text-5xl font-black leading-tight tracking-[-0.033em]">
                    Professional Financial Excellence
                  </h1>
                  <h2 className="text-white text-base lg:text-lg xl:text-xl font-normal leading-relaxed text-base font-normal leading-normal max-w-3xl">
